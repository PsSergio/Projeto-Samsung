...
const AddToCarModalButton = document.getElementsByClassName("addToCar-btn")[0];
...
const ModalCarrinhoContainer = document.getElementById("modal-carrinho");
...
const HeaderItemToOpenModalCarrinho = document.getElementsByClassName("right-items")[0];
...
const RemoveProductButtons = document.getElementsByClassName("remove-product-container");
...
const IncreaseButton = document.getElementsByClassName("increase-qty");
